...
module.exports = {
  ...
  try {
      ...
      const newsong = new MessageEmbed()
        ...
        .addField("Time <a:emoji_37:877397151083290674> :", `\`${song.duration} Minutes 🖇\``, true)
        .addField("Voice Channel <a:emoji_35:877396771427455007> :",channel.name)
        .addField("Text Channel <a:emoji_36:877397134561910806> :",message.channel.name)
        .addField("Voulome <a:emoji_34:877395811242217472> :",100)
        .setURL(song.url)
        .setColor("#146DF6")
        .setThumbnail(thumb)
